        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-last lg:order-first">
            <div className="relative aspect-[4/5] max-w-sm mx-auto rounded-4xl overflow-hidden shadow-warm-lg">
              <div className="w-full h-full bg-gradient-to-br from-sage/30 via-cream-200 to-terracotta/20 flex items-center justify-center">
                <div className="text-center text-espresso/30">
              ...
              <div className="absolute -top-4 -left-4 w-20 h-20 bg-sage/20 rounded-full -z-10" />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-terracotta text-sm font-medium uppercase tracking-widest">Nuestra Historia</span>
            </div>

            <h2 className="font-display text-4xl sm:text-5xl text-espresso leading-tight mb-6">
              Dos voces,
              <br />
              <span className="text-terracotta italic">una conversación</span>
            </h2>
            ...
            <div className="mt-10">
              <Link href="/podcast">
                <Button variant="outline" className="border-espresso/20 text-espresso hover:bg-espresso hover:text-cream">
